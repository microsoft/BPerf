...
namespace System.Management.Automation.Internal
{
    ...
    /// </summary>
    public abstract class ICabinetExtractor : IDisposable
    {
        /// <summary>
        ...
        public abstract bool Extract(string cabinetName, string srcPath, string destPath);
    ...
    /// </summary>
    public class CabinetExtractorFactory
    {
        ...
        public static ICabinetExtractor GetCabinetExtractor()
        {
    ...
    internal sealed class EmptyCabinetExtractor : ICabinetExtractor
    {
        ...
        /// <param name="srcPath">cabinet directory name, must be back slash terminated</param>
        /// <param name="destPath">destination directory name, must be back slash terminated</param>
        public override bool Extract(string cabinetName, string srcPath, string destPath)
        {
