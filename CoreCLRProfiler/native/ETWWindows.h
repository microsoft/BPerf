...
" <tasks>\n"
"  <task name=\"Log\" message=\"$(string.task_Log)\" value=\"1\"/>\n"
...
"  <event value=\"1\" version=\"0\" level=\"win:LogAlways\" symbol=\"LOHAllocation\" task=\"Log\" template=\"LOHAllocationArgs\"/>\n"
...
static ULONG WriteManifestEvent(REGHANDLE handle)
{
    ...
    dataDescriptors[6].Size = strlen(Manifest);
